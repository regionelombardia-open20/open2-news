...
EOF
                                        ...
                                        <?php if (Yii::$app->getModule('news')->params['site_publish_enabled']) { ?>
                                            ...
                                            $primoPiano = '<div class="col-md-6 col-xs-12">' . $form->field($model, 'primo_piano')->widget(Select::class, [
                                                    ...
                                                    'data' => [
                                                        ...
                                                        '1' => AmosNews::t('amosnews', 'a tutti gli utenti')
                                                    ],
                                                    'options' => [
                                                ...
                                                ])->label('Mostra notizia')->hint('La notizia sarà fruibile anche da un\'utenza non registrata') . "<div style=\"display:none\">" . $form->field($model, 'primo_piano')->hiddenInput(['value' => 1])->label(false) . '</div></div>'; // DEMO - AS REQUESTED
                                            if ($publish_enabled) {
                                                echo $primoPiano;
                                            }
                                        }
        ...
        <div class="row">
            <div class="col-xs-12 section-form">
                ...
                <!-- < ?= AccordionWidget::widget(['items' => [['header' => AmosNews::t('amosnews', '#settings_optional'), 'content' => $publicationDate . $enableComments . $contentLanguage . '<div class="clearfix"></div>']], 'headerOptions' => ['tag' => 'h2'], 'clientOptions' => ['collapsible' => true, 'active' => 'false', 'icons' => ['header' => 'ui-icon-amos am am-plus-square', 'activeHeader' => 'ui-icon-amos am am-minus-square']]]); ?> -->
                <div class="row">
                    <?= $publicationDate ?>
                </div>
